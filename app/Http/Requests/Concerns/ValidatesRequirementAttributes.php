...
trait ValidatesRequirementAttributes
{
    ...
    protected function requirementAttributeRules(): array
    {
        return [
            ...
            'accessories.*.title' => 'nullable|string|max:255',
            'accessories.*.quantity' => 'nullable|integer|min:1',
            'accessories.*.unit_id' => 'nullable|exists:units,id',
            'accessories.*.price' => 'nullable|numeric|min:0',

            'has_installation' => 'nullable|boolean',
            'installations' => 'nullable|array',
            'installations.*.title' => 'nullable|string|max:255',
            'installations.*.quantity' => 'nullable|integer|min:1',
            'installations.*.unit_id' => 'nullable|exists:units,id',
