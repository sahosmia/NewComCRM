...
trait ValidatesRequirementAttributes
{
    ...
    protected function requirementAttributeRules(): array
    {
        return [
            ...
            'accessories_quantity' => 'required_if:has_accessories,true|nullable|integer|min:0',
            ...
            'installation_quantity' => 'required_if:has_installation,true|nullable|integer|min:0',
