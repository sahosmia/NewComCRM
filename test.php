    ...
    public function invoice()
    {
        ...
        foreach ($orders as $order_id) {
            ...
            if ($order_info) {
                ...
                $find_fields = array('{company}', '{address_1}', '{address_2}', '{city}', '{postcode}', '{zone}', '{zone_code}', '{country}');
                ...
                if ($order_info['email']) {
                    $shipping_address .= '<br />' . $order_info['email'];
                }
                if ($order_info['telephone']) {
                    $shipping_address .= '<br />' . $order_info['telephone'];
                }
