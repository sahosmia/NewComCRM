                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <Badge variant="outline" className="capitalize">{user.role == 'super_admin' ? 'Super Admin' : 'User'}</Badge>
                        </div>
                        <p className="text-muted-foreground mt-1">{user.designations || 'No designation'}</p>
                    </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground flex items-center gap-2">
                                            {user.mobile || 'N/A'}
                                            {user.mobile && (
                                                <a href={`https://wa.me/88${user.mobile.replace(/\D/g, '')}`} target="_blank" className="text-emerald-500 hover:underline text-[10px] font-bold">WhatsApp</a>
                                            )}
                                        </p>
                                    </div>
                                </div>
