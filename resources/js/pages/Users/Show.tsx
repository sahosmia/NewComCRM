            ...
            <div className="p-6 max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1">{user.designation || 'No designation'}</p>
                    </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground flex items-center gap-2">
                                            {user.phone || 'N/A'}
                                            {user.phone && (
                                                <a href={`https://wa.me/88${user.phone.replace(/\D/g, '')}`} target="_blank" className="text-emerald-500 hover:underline text-[10px] font-bold">WhatsApp</a>
                                            )}
                                        </p>
                                    </div>
                                </div>
