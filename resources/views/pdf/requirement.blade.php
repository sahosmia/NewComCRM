    ...
    <table class="goods-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">{{ number_format($requirement->accessories_price * $aitFactor, 0) }}</td>
                <td class="text-right">{{ number_format($requirement->accessories_quantity * $requirement->accessories_price * $aitFactor, 0) }}/=</td>
            </tr>
            @endif
            ...
            <tr>
                ...
                <td class="text-right">{{ number_format($requirement->installation_price * $aitFactor, 0) }}</td>
                <td class="text-right">{{ number_format($requirement->installation_quantity * $requirement->installation_price * $aitFactor, 0) }}/=</td>
            </tr>
            @endif
        </tbody>
        @php
